...
1. Clónalo a tu servidor local y crea una web personalizada
2. Respeta la estructura principal:
    a. data.json para los datos que se repitan
       - site: para los datos generales del sitio (titulo, descripcion, telefono, correo, redes sociales, etc..)
