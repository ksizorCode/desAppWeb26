...
| ------------------------- | ---- | -------------- | ---------------------------------- |
| Piratas de Silicon Valley | 1999 | Historia tech  | Rivalidad entre Apple y Microsoft  |
| The Social Network        | 2010 | Redes sociales | Origen de Facebook                 |
...
## 📺 Series
| Título                       | Plataforma | Tema            | Por qué verla                            |
| ---------------------------- | ---------- | --------------- | ---------------------------------------- |
| Silicon Valley               | HBO        | Startups        | Comedia sobre emprendedores tech         |
| Halt and Catch Fire          | Filmin     | Historia tech   | Revolución de los ordenadores personales |
...
| Título                               | Plataforma | Tema             | Por qué verlo                    |
| ------------------------------------ | ---------- | ---------------- | -------------------------------- |
| The Social Dilemma                   | Netflix    | Redes sociales   | Impacto psicológico y social     |
| The Great Hack                       | Netflix    | Datos / política | Escándalo Cambridge Analytica    |
